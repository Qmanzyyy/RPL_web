  ...
  <div class="py-4 overflow-y-auto">
    ...
    <a href="DaftarSiswa.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
       ...
       <span class="flex-1 ms-3 whitespace-nowrap">Daftar Siswa</span>
         ...
         <li>
            <a href="https://www.instagram.com/nexzmetacoenubia/" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
