...
<!-- main -->
    ...
    <div class="relative w-full h-full text-white flex flex-col justify-center">
        ...
        <div class="grid mb-10 bg-white rounded-md grid-cols-3 p-5 gap-5">
            ...
            <div class="">
                <a href="#" class="flex justify-center items-center bg-black p-3 group hover:bg-slate-900 rounded-full">
            ...
            <div class="col-span-1">
                <a href="login.php" class="flex justify-center items-center bg-black p-3 group hover:bg-slate-900 rounded-full">
