...
<body class="h-screen">
    ...
    <!-- main -->
    <main class=" w-full h-full bg-[url('BG.jpg')] bg-cover">
        <div class="flex flex-col items-center justify-center h-full backdrop-blur-sm">
          ...
          <div class='console-container md:text-3xl text-lg'>
            ...
            <a href="./Menu.php" class=" mt-3 border text-lg p-3 flex items-center rounded-full text-white bg-black border-white hover:bg-white hover:text-black group focus:ring-offset-2 focus:ring-4 focus:ring-blue-600">
...
<script>
 ...
 consoleText(['Make progress.', 'Be creative.', 'Make better.'], 'text',['red','green','blue']);
